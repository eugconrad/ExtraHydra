...
_TRANS = const("""[
  {"en": "Paste", "zh": "粘贴", "ja": "貼り付け", "ru": "Вставить", "uk": "Вставити"},
  {"en": "New Directory", "zh": "新建目录", "ja": "新しいディレクトリ", "ru": "Новая папка", "uk": "Нова папка"},
  {"en": "New File", "zh": "新建文件", "ja": "新しいファイル", "ru": "Новый файл", "uk": "Новий файл"},
  {"en": "Refresh", "zh": "刷新", "ja": "更新", "ru": "Обновить", "uk": "Оновити"},
  {"en": "Exit to launcher", "zh": "退出到启动器", "ja": "ランチャーに戻る", "ru": "Выйти в лаунчер", "uk": "Вийти до лаунчера"},
  {"en": "Directory name:", "zh": "目录名称:", "ja": "ディレクトリ名:", "ru": "Имя папки:", "uk": "Назва папки:"},
  {"en": "File name:", "zh": "文件名称:", "ja": "ファイル名:", "ru": "Имя файла:", "uk": "Назва файлу:"},
  {"en": "Exiting...", "zh": "正在退出...", "ja": "終了中...", "ru": "Выход...", "uk": "Вихід..."},
  {"en": "open", "zh": "打开", "ja": "開く", "ru": "открыть", "uk": "відкрити"},
  {"en": "copy", "zh": "复制", "ja": "コピー", "ru": "копировать", "uk": "копіювати"},
  {"en": "rename", "zh": "重命名", "ja": "名前を変更", "ru": "переименовать", "uk": "перейменувати"},
  {"en": "delete", "zh": "删除", "ja": "削除", "ru": "удалить", "uk": "видалити"},
  {"en": "Opening...", "zh": "正在打开...", "ja": "開いています...", "ru": "Открытие...", "uk": "Відкриття..."}
]""")
