...
_TRANS = const("""[
    {"en": "Loading...", "zh": "加载中...", "ja": "読み込み中...", "ru": "Загрузка...", "uk": "Завантаження..."},
    ...
    {"en": "UI Sound", "zh": "界面声音", "ja": "UIサウンド", "ru": "Звук интерфейса", "uk": "Звук інтерфейсу"},
    {"en": "Settings", "zh": "设置", "ja": "設定", "ru": "Настройки", "uk": "Налаштування"},
    {"en": "On", "zh": "开", "ja": "オン", "ru": "Вкл", "uk": "Увімк"},
    {"en": "Off", "zh": "关", "ja": "オフ", "ru": "Выкл", "uk": "Вимк"}
]""")
